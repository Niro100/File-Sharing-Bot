...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("පොඩ්ඩක් හිටහං...!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("මොකක් හරි අවුලක් බං..!")
        return
    ...
    await reply_text.edit(f"<b>මෙන්න උඹේ Link එක 👇</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
